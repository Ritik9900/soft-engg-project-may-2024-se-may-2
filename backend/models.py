...
#     name = db.Column(db.String(100), nullable=False)
#     description = db.Column(db.Text, nullable=True)
#     # snippets = db.relationship("CodeSnippet", backref="course", lazy=True)
#     weeks = db.relationship("Week", backref="course", lazy=True)
...
#     lecture_url = db.Column(db.Text, nullable=False)
#     week_id = db.Column(db.Integer, db.ForeignKey("week.id"), nullable=False)
...
#     course_id = db.Column(db.Integer, db.ForeignKey("course.id"), nullable=False)
#     solution = db.Column(db.Text, nullable=True)  # New field for the solution

#     def __init__(self, question, code, test_cases, user_id, course_id, solution=None):
#         self.question = question
#         self.code = code
#         self.test_cases = test_cases
#         self.user_id = user_id
#         self.course_id = course_id
#         self.solution = solution  # Initialize the solution field
